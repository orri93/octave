function [Kp, Ki, Kd, Ti, Td] = report191122(di = 0, type = 0, outdir = '')
...
scrarr(index).di = 1;
scrarr(index).type = 0;
scrarr(index).publish = 2;
scrarr(index).utitle = "general";
index = index + 1;
scrarr(index).di = 2;
scrarr(index).type = 0;
scrarr(index).publish = 3;
scrarr(index).utitle = "general";
index = index + 1;
scrarr(index).di = 3;
scrarr(index).type = 0;
scrarr(index).publish = 4;
scrarr(index).utitle = "general";
index = index + 1;
...
publish("report191122script.m", options); 
